...
const wFinish = new Word("Finish");
const pFinish = new Prompt(wFinish);

export function createEighthAugustPage1(gameContainer, promptsEighthAugustPage1){
    const eighthAugustPage1 = new Scene(gameContainer, promptsEighthAugustPage1);
    eighthAugustPage1.playScene();
    pFinish.func = finish;
    Scene.options.push(pFinish);
    console.log('Scene.options', Scene.options);
}


export function finish(gameContainer) {
    gameContainer.innerHTML = "";
    let sWellDone = Sentence.fromString("Well done! You have completed this scene.");
    const pWellDone = new Prompt(sWellDone);
    gameContainer.appendChild(pWellDone.div);
    pWellDone.isCurrent();
}

function createNinthAugustPage1(gameContainer, promptsNinthAugustPage1){
